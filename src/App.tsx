...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState<
    "home" | "whatsapp" | "email" | "sms" | "browser"
  >("home");
      ...
      <div className="container mx-auto px-4 py-6">
        {currentView === "home" ? (
              ...
              <div className="pt-8 border-t border-border">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground">
                    Additional UI components and prototypes
                  </p>
                </div>
                ...
                <div className="pt-8 border-t border-border">
                  <div className="mb-6">
                    ...
                    <p className="text-muted-foreground">
                      Sophisticated UI components for demo
                      purposes
                    </p>
                  </div>
          ...
          <div className="space-y-6">
            {currentView === "email" && (
              <InteractiveStandaloneMail
                onBack={() => setCurrentView("home")}
              />
            )}
            {currentView === "sms" && (
              <InteractiveStandaloneSMS
                onBack={() => setCurrentView("home")}
              />
            )}
            {currentView === "whatsapp" && (
              <InteractiveStandaloneWhatsApp
                onBack={() => setCurrentView("home")}
              />
            )}
            {currentView === "browser" && (
              <InteractiveSecureLink
                onBack={() => setCurrentView("home")}
              />
            )}
          </div>
